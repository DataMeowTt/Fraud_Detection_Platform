 ...
 *                  Rules PASS   -> CEP Engine    -> BLOCK/ALERT? -> output   (stub, never fires yet)
 *                  CEP PASS     -> ML Engine     -> score >= threshold? -> output (stub, never scores yet)
 *                  else                          -> APPROVED
 */
